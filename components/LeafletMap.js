...
export default function LeafletMap(props) {
  ...
  'wght' 400,
  'GRAD' 0,
  'opsz' 48`}} className="material-symbols-outlined text-center z-[401] absolute bottom-32 right-10 bg-[#f1f3f4] rounded-full h-16 w-16 p-3 text-4xl shadow-lg text-gray-800">
        my_location
        </AnimatedButton>
